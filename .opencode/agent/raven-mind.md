...
- **Convención de Etiquetado**: Cada archivo fuente nuevo o modificado debe comenzar en la primera línea con un encabezado de etiquetas (tags: `# tags: [core, mcp, ...]`) para facilitar las búsquedas globales de agentes y ripgrep/grep, tal como se especifica en la skill `munin-management`.
