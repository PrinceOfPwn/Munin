...
DEFAULT_AGENT_PROFILES: tuple[AgentProfile, ...] = (
    ...
    _profile("hugin-librarian", "Hugin Librarian", "Retrieve the smallest trusted Hugin/Strix skill subset for the active subtask.", ("skill_search", "skill_read", "evidence_index"), ("hugin", "strix"), "low", "One to five relevant, provenance-labeled skills are released after use."),
