...
>
> Другие провайдеры, модели, целевые среды развертывания и интерфейсы управления могут работать, но они не входят в проверенную конфигурацию v1.1.0, если это не задокументировано явно.
