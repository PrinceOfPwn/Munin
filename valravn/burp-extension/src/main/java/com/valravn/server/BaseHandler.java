...
import com.valravn.http.HttpHandler;
...
public abstract class BaseHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        com.valravn.http.ProxyTunnel.clearLastSendFellBack();
        ...
        try {
            ...
            com.valravn.ui.ConfigTab.log("BAD_JSON: " + path + " -> " + e.getMessage());
            sendError(exchange, 400,
                "Malformed JSON body: " + e.getMessage(),
                "validation_failed",
                "Verify the request body is valid JSON before retrying.");
        } catch (Exception e) {
            com.valravn.ui.ConfigTab.log("ERROR: " + path + " -> " + e.getMessage());
