...
public class FindingsStore {
     ...
     * the Python .valravn-intel status + retest vocabulary. Returns the mutated
    ...
    public void loadFromJson(String json) {
        ...
        List<Object> parsed;
        try {
            parsed = com.valravn.util.JsonUtil.parseArray(json);
        } catch (Exception e) {
    ...
    public String exportMarkdown() {
        ...
        sb.append("Testing performed using Valravn MCP with Claude Code.\n");
    ...
    public String exportJson() {
        ...
        for (int i = 0; i < findings.size(); i++) {
            if (i > 0) sb.append(",");
            sb.append(com.valravn.util.JsonUtil.toJson(findings.get(i)));
        }
     ...
     * dashboard match the persistent .valravn-intel/ store.
     */
