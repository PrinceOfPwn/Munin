...
public class ScopeHandler extends BaseHandler {
    ...
    // Cold-start: read .valravn-intel/_scope_mode.json (the Python source of truth)
    ...
    static void reloadMode() {
        try {
            java.nio.file.Path stateFile = java.nio.file.Path.of(".valravn-intel", "_scope_mode.json");
