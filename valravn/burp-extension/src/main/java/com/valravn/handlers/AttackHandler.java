...
import com.valravn.attack.AuthMatrixHandler;
import com.valravn.attack.HppHandler;
import com.valravn.attack.RaceHandler;
 ...
 * collaborator in {@link com.valravn.attack}:
 *
 *   /api/attack/auth-matrix -> AuthMatrixHandler
 *   /api/attack/race        -> RaceHandler
 *   /api/attack/hpp         -> HppHandler
 *
 * Session state is read via {@link com.valravn.store.SessionStore} singleton
