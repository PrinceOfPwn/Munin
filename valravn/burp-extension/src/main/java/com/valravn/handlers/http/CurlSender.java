package com.valravn.handlers.http;
...
import com.valravn.attack.AttackScope;
...
public final class CurlSender {
    ...
    public void handle(HttpExchange exchange, Map<String, Object> body) throws Exception {
        ...
        if (result == null) {
            ...
            String why = com.valravn.http.ProxyTunnel.lastSendError();
        ...
        while (followRedirects && redirectCount < maxRedirects && result.response() != null) {
            ...
            result = com.valravn.http.ProxyTunnel.sendOrFallback(api, nextRequest);
            service = nextService;
            redirectCount++;
        }
        ...
        if (resp != null) {
            ...
            int cap = com.valravn.server.ResponseLimits.MAX_RESPONSE_BODY;
