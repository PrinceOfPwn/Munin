"""Per-engagement cost cap. Tokens + USD ceiling, persisted under .valravn-intel/.

pentest-ai ships a $10 default cap. Valravn's equivalent — operators set a
...
Persisted at .valravn-intel/<domain>/cost.json:
    {
        "max_usd": 25.0,
        "max_tokens": 5000000,
        "spent_usd": 4.21,
