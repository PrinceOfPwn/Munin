...
def register(mcp: FastMCP):
    ...
    async def curl_request(
        ...
        Realistic browser headers are auto-injected unless already set or bare_headers=True; a saved profile (.valravn-intel/<domain>/profile.json) overrides defaults. Caller-supplied headers/auth/bearer/cookies always win.
