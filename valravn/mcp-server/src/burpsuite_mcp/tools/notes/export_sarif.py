...
most CI security gates. Lets a DAST finding from Valravn surface in the same
    ...
    for f in findings:
        ...
        if rid not in rule_ids:
            ...
            rule_ids[rid] = {
                ...
                "fullDescription": {
                    "text": f"Valravn DAST finding category: {vuln}. Compliance: {', '.join(tags) if tags else 'none mapped'}."
                },
        ...
        "runs": [
            {
                "tool": {
                    "driver": {
                        "name": "Valravn",
                        "version": "1.0.0",
                        "informationUri": "https://github.com/PrinceOfPwn/Valravn",
