...
bugs live in the *invariants* a system assumes. This tool ingests:
  ...
  3. Tech stack hints from .valravn-intel/<domain>/profile.json.
...
Each invariant comes with a hypothesised attack and the recommended Valravn
...
def register(mcp: FastMCP) -> None:
    ...
    async def infer_business_invariants(
        ...
        Reads endpoints from `.valravn-intel/<domain>/endpoints.json` (saved by
        ...
        Valravn tool to fire for each. This is synthesis, not execution.
