...
# calls. Valravn has no runaway backstop — a bad plan can fire the same probe
...
# an injection string into scan output can't hijack the agent. Valravn ingests
...
# Valravn runs as a stdio MCP process and most state (Burp sessions, repeater
