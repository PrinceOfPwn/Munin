...
NL->probe without a weekly KB-file drop. Claude reasons the matcher JSON (Valravn
...
def register(mcp: FastMCP) -> None:
    ...
    async def run_adhoc_probe(
        ...
        You (the model) author the probe matcher JSON — Valravn validates it against
