/*
 * Universal Android SSL pinning bypass (Valravn W8 / mobile-mastg).
 *
...
Java.perform(function () {
  console.log('[+] Valravn SSL-pin bypass loaded');

  // 1. X509TrustManager — root of most pinning checks.
  var TrustManager = Java.registerClass({
    name: 'valravn.ValravnTrustManager',
  ...
  var HNVImpl = Java.registerClass({
    name: 'valravn.ValravnHostnameVerifier',
