...
class RouteWalkbackTest(unittest.TestCase):
    ...
    def setUp(self):
        self.tmp = Path(tempfile.mkdtemp(prefix="valravn-sast-route-"))
...
class AggregateEndpointsTest(unittest.TestCase):
    ...
    def setUp(self):
        self.tmp = Path(tempfile.mkdtemp(prefix="valravn-sast-agg-"))
...
class SastToEndpointRiskToolTest(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        self.tmp = Path(tempfile.mkdtemp(prefix="valravn-sast-tool-"))
        self.prev = Path.cwd()
        os.chdir(self.tmp)
...
class RiskRankEndpointsToolTest(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        self.tmp = Path(tempfile.mkdtemp(prefix="valravn-sast-risk-"))
