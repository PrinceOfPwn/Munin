...
class TestProjection(unittest.TestCase):
    ...
    def test_write_creates_current_md(self):
        ...
        cur = Path(".valravn-intel/x.test/findings/VULN-001/current.md")
    ...
    def test_remove_deletes_folder(self):
        ...
        self.assertFalse(Path(".valravn-intel/x.test/findings/VULN-001").exists())
    ...
    def test_hard_delete_removes_projection(self):
        ...
        self.assertTrue(Path(".valravn-intel/x.test/findings/VULN-001").exists())
    ...
    def test_record_retest_versions(self):
        ...
        self.assertTrue(Path(".valravn-intel/x.test/findings/VULN-001/v1_2026-09-01_reopened.md").exists())
        self.assertTrue(Path(".valravn-intel/x.test/findings/VULN-001/v2_2026-10-15_fixed.md").exists())
