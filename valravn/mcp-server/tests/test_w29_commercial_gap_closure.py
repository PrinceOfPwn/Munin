...
class W29WebLlmHelpers(unittest.TestCase):
    ...
    def test_canary_is_unique_per_call(self):
        ...
        self.assertTrue(a.startswith("VALRAVN-"))

    def test_marker_echoed_case_insensitive(self):
        from burpsuite_mcp.tools.web_llm_sweep import _marker_echoed
        self.assertTrue(_marker_echoed("hello VALRAVN-AB12 world", "valravn-AB12"))
        self.assertFalse(_marker_echoed("hello world", "valravn-AB12"))
    ...
    def test_html_unescaped_check(self):
        ...
        canary = "CANARYABC"
        good = f"<script>window.__valravn__='{canary}'</script>"
        bad = "&lt;script&gt;window.__valravn__='CANARYABC'&lt;/script&gt;"
