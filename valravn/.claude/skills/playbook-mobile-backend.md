...
description: 移动应用后端漏洞，跨全传输类型 (REST、GraphQL、gRPC-Web、WebSocket、SSE)。MASTG/OWASP Mobile Top 10 对齐——BOLA、BFLA、过度数据暴露、设备绑定 token、IAP 绕过、deep-link 注入、push-token 欺骗、可预测 ID、WS 劫持、GraphQL batch 滥用、gRPC 服务枚举。
