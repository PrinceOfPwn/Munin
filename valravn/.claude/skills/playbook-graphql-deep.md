---
description: GraphQL 深探——introspection / 字段提示 / batching / alias DoS / 深度限制 / persisted query 绕过 / subscription 协议漂移。Apollo / graphql-js / Hasura / PostGraphile / Mercurius 引擎细节。当目标暴露 /graphql 时载入。
globs:
---
