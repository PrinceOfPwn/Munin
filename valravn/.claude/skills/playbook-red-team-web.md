...
description: OWASP 之外的高阶 web 利用链——SSO/OAuth/SAML 漏洞、反序列化 gadget、依赖混淆、web LLM 注入、云原生攻击 (IMDS、K8s、Lambda、S3、IAM)。当用户要求 "red team this" 或 recon 发现 SSO/云/序列化数据时载入。
