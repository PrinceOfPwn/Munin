---
description: OAuth 2.0 / OIDC 流程攻击——Authorization Code / PKCE / Device Code / Client Credentials。Mix-up、redirect_uri 怪癖、state CSRF、jku 替换、PAR-DPoP (2024-2025)。当目标用 OAuth/OIDC 时载入。
globs:
---
