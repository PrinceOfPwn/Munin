...
description: 深探鉴权+支付攻击面——OAuth 2.0 / OIDC、WebAuthn / FIDO2 / passkey、Google Pay、Apple Pay、Samsung Pay、IAP 收据校验、3DS 2.x 绕过、SCA 豁免滥用、recovery 流程降级。资金流 / 账号接管级别；凡有此面之项目，皆最高赏金。
