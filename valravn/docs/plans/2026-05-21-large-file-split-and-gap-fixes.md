...
- Create: `burp-extension/src/test/java/com/valravn/analysis/MatcherEngineTest.java`
- Create: `burp-extension/src/test/java/com/valravn/handlers/ScopeHandlerColdStartTest.java`
...
class ScopeHandlerColdStartTest {
    ...
    void coldStartReadsModeFromStateFile() throws Exception {
        Path intel = Paths.get(".valravn-intel");
...
**Files:**
- Modify: `burp-extension/src/main/java/com/valravn/handlers/SessionHandler.java` (→ ~200 lines, router only)
- Create: `burp-extension/src/main/java/com/valravn/store/SessionStore.java`
- Create: `burp-extension/src/main/java/com/valravn/session/SessionRequestExecutor.java`
- Create: `burp-extension/src/main/java/com/valravn/session/VariableExtractor.java`
- Create: `burp-extension/src/main/java/com/valravn/session/FlowRunner.java`
- Create: `burp-extension/src/main/java/com/valravn/session/AttackSurfaceDiscovery.java`
- Create: `burp-extension/src/main/java/com/valravn/session/AutoProbeOrchestrator.java`
- Create: `burp-extension/src/main/java/com/valravn/session/BatchProbeHandler.java`
- Create: `burp-extension/src/main/java/com/valravn/session/SessionExtractHandler.java`
- Create: `burp-extension/src/test/java/com/valravn/store/SessionStoreTest.java`
- Create: `burp-extension/src/test/java/com/valravn/session/VariableExtractorTest.java`
...
```java
package com.valravn.store;

import com.valravn.handlers.Session;
import java.util.*;
...
import com.valravn.store.SessionStore;
import com.valravn.session.*;
...
Run: `grep -c "createContext" burp-extension/src/main/java/com/valravn/server/ApiServer.java`
Expected: 28.
...
```bash
git add burp-extension/src/main/java/com/valravn/store/SessionStore.java \
        burp-extension/src/main/java/com/valravn/session/ \
        burp-extension/src/main/java/com/valravn/handlers/SessionHandler.java \
        burp-extension/src/test/java/com/valravn/store/SessionStoreTest.java \
        burp-extension/src/test/java/com/valravn/session/VariableExtractorTest.java
...
**Files:**
- Modify: `burp-extension/src/main/java/com/valravn/handlers/AttackHandler.java` (→ thin router)
- Create: `burp-extension/src/main/java/com/valravn/attack/AuthMatrixHandler.java`
- Create: `burp-extension/src/main/java/com/valravn/attack/RaceHandler.java`
- Create: `burp-extension/src/main/java/com/valravn/attack/HppHandler.java`
- Create: `burp-extension/src/main/java/com/valravn/attack/AttackContext.java` (if shared state present)
- Create: `burp-extension/src/test/java/com/valravn/attack/AuthMatrixHandlerTest.java` (smoke)

- [ ] **Step 1: Read AttackHandler.java, identify routes**

`grep "case \"" burp-extension/src/main/java/com/valravn/handlers/AttackHandler.java` to find dispatch table.
...
git add burp-extension/src/main/java/com/valravn/attack/ \
        burp-extension/src/main/java/com/valravn/handlers/AttackHandler.java \
        burp-extension/src/test/java/com/valravn/attack/
...
**Files:**
- Modify: `burp-extension/src/main/java/com/valravn/ui/ConfigTab.java` (→ ~100 lines, JTabbedPane composition only)
- Create: `burp-extension/src/main/java/com/valravn/ui/ScopePanel.java`
- Create: `burp-extension/src/main/java/com/valravn/ui/InterceptPanel.java`
- Create: `burp-extension/src/main/java/com/valravn/ui/MatchReplacePanel.java`
...
```bash
git add burp-extension/src/main/java/com/valravn/ui/
...
**Files:**
- Modify: `burp-extension/src/main/java/com/valravn/audit/ScopeAuditLog.java`
- Create: `burp-extension/src/test/java/com/valravn/audit/ScopeAuditLogRotationTest.java`

- [ ] **Step 1: Add rotateIfNeeded() to ScopeAuditLog.java**

```java
package com.valravn.audit;
...
class ScopeAuditLogRotationTest {
    ...
    void rotatesWhenLogExceeds10MB() throws Exception {
        ...
        Path log = tmpDir.resolve(".valravn-intel/_audit.log");
...
```bash
cd burp-extension && mvn clean package && mvn test
git add burp-extension/src/main/java/com/valravn/audit/ScopeAuditLog.java \
        burp-extension/src/test/java/com/valravn/audit/
...
- [ ] `grep -c "createContext" burp-extension/src/main/java/com/valravn/server/ApiServer.java` = 28
